...
import type { AssessmentStatus } from '@/lib/shared/clinician/assessment-labels'
import { LONGITUDINAL_CODES } from '@/lib/shared/questionnaires/registry'
    ...
    await Promise.all([
      ...
      supabase
        ...
        .in(
          ...
          LONGITUDINAL_CODES as unknown as string[]
        )
